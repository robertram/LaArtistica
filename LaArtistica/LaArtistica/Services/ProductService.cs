    ...
    public class ProductService
    {
        ...
        public List<Products> GetProducts()
        {
            return new List<Products>
            {
                ...
                new Products{ Id = 2, Nombre = "Maimz Loveseat", Imagen = "orange.jpg", Precio = "$880", Descripcion = "his designer loveseat is mid-century revival done to perfection. Linear and minimalistic, the beautifully edited profile has all the retro elements you love, like sheltering arms, bolster pillows and tapered splayed legs. So casually cool, the caramel faux leather upholstery brings the look right into the present." },
                new Products{ Id = 3, Nombre = "Sofá RTA Macleary", Imagen = "pink.jpg", Precio = "$750", Descripcion = "Ponte cómodo con una estética moderna cuando agregues este sofá de dos puestos a tu casa u oficina. Un diseño limpio y lineal se adapta muy bien a cualquier espacio sofisticado. Con tapicería de terciopelo y una elegante pata metálica, esta pieza eleva tu decoración a la última moda." },
